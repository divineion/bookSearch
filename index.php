...
while(! feof($file))
  {
    ...
    if ($i==1) {
        $header = $bookData; //on récupère les en-têtes du CSV
        continue;
    }
...
$sortResult = $library->sortByFilters("publisher");
...
-->
                                ...
                                <div class="product product__style--3 col-lg-4 col-md-4 col-sm-6 col-12">
                                    <div class="product__thumb">
                                        <a class="first__img" href="single-product.html"><img
                                                src="https://template.hasthemes.com/boighor/boighor/images/books/3.jpg" alt="product image"></a>
                                        <a class="second__img animation1" href="single-product.html"><img
